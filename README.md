...
# Restart the panel
systemctl restart kroxy-panel

# View live logs
journalctl -u kroxy-panel -f

# View error logs
cat /opt/kroxy-panel/logs/error.log
```
...
cd /opt/kroxy-panel && npm install
systemctl restart kroxy-panel
...
MIT — built by [KROXY](https://github.com/ElXora)
